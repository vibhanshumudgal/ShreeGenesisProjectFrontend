  ...
  return (
    <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 shadow-xl rounded-3xl p-8 mb-8 border border-gray-200 w-full max-w-3xl mx-auto transition hover:scale-[1.02] duration-300 ease-in-out">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 italic">Application ID: {data._id}</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
        ...
        <p><span className="font-semibold">Branch:</span> {data.branch}</p>
        <p><span className="font-semibold">College:</span> {data.college_name}</p>
        <p><span className="font-semibold">Father:</span> {data.father_name}</p>
        <p><span className="font-semibold">Mother:</span> {data.mother_name}</p>
        <p className="col-span-2"><span className="font-semibold">Address:</span> {data.address}</p>
